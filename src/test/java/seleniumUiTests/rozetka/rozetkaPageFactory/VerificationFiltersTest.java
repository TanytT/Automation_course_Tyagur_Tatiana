...
import com.company.homeworks.HW23.pageFactory.rozetkaFiltersPages.FilterPhoneFactoryPage;
import com.company.homeworks.HW23.pageFactory.rozetkaFiltersPages.FiltersHomeFactoryPage;
...
public class VerificationFiltersTest extends BaseUiTest {
    ...
    FilterPhoneFactoryPage phonePage;

    @BeforeMethod
    public void startUp(){
        driver.get(url);
        driver.manage().window().maximize();
        FiltersHomeFactoryPage homePage = new FiltersHomeFactoryPage(driver);
        phonePage = new FilterPhoneFactoryPage(driver);
    ...
    public void priceFilterTest() {
        ...
        assertTrue(phonePage.isPhoneWithPrice(phonePage.getPhoneListByPrice(),price1, price2),"The price of phone out of range 5000-15000.");
    }
